...
class AttractionList extends React.Component<Props, State> {
    ...
    joinAttractions(attractions: Array<Attraction>): string{

        var joinedString = "";

        attractions.forEach((attraction) => {
            joinedString += attraction.name + "/";
        })
    ...
    componentDidMount(): void {        
        ...
        const googleMapsLink = "https://www.google.com/maps/dir/" + this.joinAttractions(attractions);
        this.setState({
	...
	render() {
		return (
                ...
                <div className="btn-group d-flex align-items-center justify-content-center">
                    ...
                    <div className="btn-group d-flex align-items-center justify-content-center">
                        <a href={this.state.googleMapsLink} >
                            Google Maps Link
                        </a>
                    </div>
